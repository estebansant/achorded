...
const JacksonRhoads = ({ addToCart, product }) => {
  ...
  const RemoveCurrentGuitar = CarouselNewArray.splice(8, 1);
  ...
  return (
    <main>
        {ProductsData.map((first) => first.JacksonRhoads?.map((product, index) => {
          return (
