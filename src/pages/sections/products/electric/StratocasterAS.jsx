...
const StratocasterAS = ({ addToCart, added, addItem }) => {
  ...
  const RemoveCurrentGuitar = CarouselNewArray.splice(6, 1);
  ...
  return (
    <main>
        {added.filter(item => item.id === 7).map(((product, index) => {
          return (
