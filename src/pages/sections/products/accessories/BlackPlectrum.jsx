...
const BlackPlectrum = ({ addToCart, added, addItem }) => {
  ...
  return (
    <main>
        {added.filter(item => item.id === 24).map(((product, index) => {
          return (
            <section key={index} className="main__containerB">
              ...
              <div className="main__containerB--wrapper">
                ...
                <section className="suggested">
                  ...
                  {ItemData.filter(item => item.id > 18 && item.id < 24 || item.id > 24).map((slide, index) => {
                        return(
