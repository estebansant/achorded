...
const PlectrumBundle = ({ addToCart, added, addItem }) => {
  ...
  return (
    <main>
        {added.filter(item => item.id === 21).map(((product, index) => {
          return (
              ...
              <div className="main__containerB--wrapper">
                ...
                <section className="suggested">
                  ...
                  <Slider {...settings} className="carouselAC">
                    {ItemData.filter(item => item.id > 18 && item.id < 21 || item.id > 21).map((slide, index) => {
                        return(
