...
const SpiderPlectrum = () => {
  ...
  const CarouselNewArray = AccessoriesCarouselData.splice(3, 1);

  return (
    <main>
        {ProductsData.map((first) => first.SpiderPlectrum?.map((product, index) => {
          return (
