...
const TemplarPlectrum = ({ addToCart, added, addItem }) => {
  ...
  return (
    <main>
        {added.filter(item => item.id === 23).map(((product, index) => {
          return (
            <section key={index} className="main__containerB">
              ...
              <div className="main__containerB--wrapper">
                ...
                <section className="suggested">
                  ...
                  {ItemData.filter(item => item.id > 18 && item.id < 23 || item.id > 23).map((slide, index) => {
                        return(
